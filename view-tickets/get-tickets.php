...
while ($ticket = $result->fetch_assoc())
{
    ...
    {
        $addCallLog = "
            <a class=\"action-icon\" href=\"/create-call-log/?id={$ticketID}\" title=\"Create a new call log for this ticket.\">
    ...
    echo "
        <tr>
            ...
            <td class=\"text-centered\">
                <a class=\"action-icon\" href=\"/ticket/?id={$ticketID}\" title=\"View information about this ticket.\">
                    <svg width=\"17\" class=\"cell-middle\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\">
